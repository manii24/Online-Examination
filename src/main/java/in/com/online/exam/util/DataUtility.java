...
public static String getDateString1(Date date) {
	...
	public static Timestamp getCurrentTimestamp() {
	 ...
	 public static String getSubDate(int month) {
		 	Date referenceDate = new Date();
			Calendar c = Calendar.getInstance(); 
			c.setTime(referenceDate); 
			c.add(Calendar.MONTH,month);
			return DataUtility.getDateString(c.getTime());
	 }
	 ...
	 public static long getDateDays(String today,String end) {
		 LocalDate d1 = LocalDate.parse(today, DateTimeFormatter.ISO_LOCAL_DATE);
		 LocalDate d2 = LocalDate.parse(end, DateTimeFormatter.ISO_LOCAL_DATE);
