                    ...
                    <b><%@ include file="businessMessage.jsp"%></b>
                		<div class="form-row">
							...
							<div class="form-group">
								<s:bind path="skills">
								<label >Skills:</label> 
								<sf:textarea rows="4" cols="4" path="${status.expression}" placeholder="Enter Skills" class="form-control" />
									<font color="red" style="font-size: 13px"><sf:errors
											path="${status.expression}" /></font>
							</s:bind>
							</div>
							...
							<div class="form-group">
								...
								<sf:textarea rows="4" cols="4" path="${status.expression}" placeholder="Enter Qualification" class="form-control" />
									<font color="red" style="font-size: 13px"><sf:errors
											path="${status.expression}" /></font>
							</s:bind>
							</div>
								...
								<div class="form-group">
								<s:bind path="workExperience">
								<label >Work Experience:</label> 
								<sf:textarea rows="4" cols="4" path="${status.expression}" placeholder="Enter Work Experience" class="form-control" />
									<font color="red" style="font-size: 13px"><sf:errors
											path="${status.expression}" /></font>
							</s:bind>
							</div>
